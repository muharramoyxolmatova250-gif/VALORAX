...
import { g as toHex$1 } from "./stringify-FRpwCepn.js";
import { It as fallback } from "./exports-vU-C8amB.js";
import { t as http } from "./http-xy5gi5c_.js";
import { A as MELD_PUBLIC_KEY, C as AssetUtil, D as CoreHelperUtil, E as OptionsController, F as proxy, I as ref, L as subscribe, M as NetworkUtil, N as ConstantsUtil$1, O as StorageUtil, P as subscribeKey, S as AlertController, T as withErrorBoundary, _ as ConnectorController, b as ApiController, c as ModalController, d as ChainController, f as SendController, g as W3mFrameRpcConstants, h as SnackController, j as ONRAMP_PROVIDERS, k as ConstantsUtil$3, l as AccountController, m as ConnectionController, o as setColorTheme, p as PublicStateController, s as setThemeVariables, t as ConstantsUtil$2, u as BlockchainApiController, v as ThemeController, x as EventsController, y as RouterController } from "./ConstantsUtil-CkBNWG8x.js";
import { t as require_events } from "./events-Bbp-bV97.js";
import { A as safeJsonParse, C as sn$4, D as k$3, E as import_browser, F as require_cjs, M as i$1, N as r, O as y$3, P as IEvents, S as Qo, T as E$3, _ as require_cjs$2, a as isJsonRpcRequest, b as Po$3, c as formatJsonRpcError, d as getBigIntRpcId, f as payloadId, g as esm_default, i as isJsonRpcError, j as safeJsonStringify, k as h$2, l as formatJsonRpcRequest, m as fromString, n as f$2, o as isJsonRpcResponse, p as toString, r as o, s as isJsonRpcResult, t as f$3, u as formatJsonRpcResult, v as require_cjs$1, w as A$2, x as Qe$4, y as detect } from "./index.es-DNOvXiIA.js";
import { f as C$4, p as concat } from "./index.es-DgIkiBha.js";
...
function Ac$1(t) {
	...
	function a(p) {
		...
		return m && (N = X$2(N, O)), ft$3("private key", N, K$2, O), N;
	}
	function u(p) {
	...
	class h {
		...
		multiplyUnsafe(d) {
			...
			for (; $ > dt$3 || A > dt$3;) $ & K$2 && (T = T.add(L)), A & K$2 && (S = S.add(L)), L = L.double(), $ >>= K$2, A >>= K$2;
		...
		multiplyAndAddUnsafe(d, v, m) {
			const O = h.BASE, N = (B, A) => A === dt$3 || A === K$2 || !B.equals(O) ? B.multiplyUnsafe(A) : B.multiply(A), $ = N(this, v).add(N(d, m));
			return $.is0() ? void 0 : $;
		}
		toAffine(d) {
			return l(this, d);
...
function Ic$1(t) {
	...
	const { ProjectivePoint: a, normPrivateKeyToScalar: u, weierstrassEquation: l, isWithinCurveOrder: f } = Ac$1({
		...
		fromBytes(g) {
			...
			if (w === o && (b === 2 || b === 3)) {
				const R = Ot$3(I);
				if (!Ee$5(R, K$2, n.ORDER)) throw new Error("Point is not on curve");
				const x = l(R);
				let C;
				try {
					C = n.sqrt(x);
	...
	class d {
		...
		assertValidity() {
			ft$3("r", this.r, K$2, r), ft$3("s", this.s, K$2, r);
		}
		addRecoveryBit(w) {
...
async function recoverPublicKey({ hash, signature }) {
	...
	const { secp256k1 } = await import("./secp256k1-B7tMZhg7.js");
	return `0x${(() => {
...
var AppKit = class extends AppKitBaseClient {
	...
	async injectModalUi() {
		if (!isInitialized && CoreHelperUtil.isClient()) {
			await import("./basic-AdxJ1E8E.js");
			await import("./w3m-modal-CG3ikGHo.js");
