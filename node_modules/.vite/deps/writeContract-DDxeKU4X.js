...
import { A as BaseError, C as isHex, S as size, a as hexToBigInt, d as toBytes$2, g as toHex$2, l as hexToBytes$1, m as numberToHex, n as LruMap$1, o as hexToBool, p as bytesToHex$1, s as hexToNumber$1 } from "./stringify-FRpwCepn.js";
import { $ as stringify, A as padRight, B as from$6, Bt as modifiers, C as from$7, D as fromString$1, Dt as ContractFunctionRevertedError, E as fromNumber, Et as ContractFunctionExecutionError, F as toNumber$1, Ft as parseSignature, G as size$2, Gt as ChainNotFoundError, H as fromString, Ht as parseAccount, It as splitParameters, J as toBoolean, K as slice$1, L as trimLeft, Lt as InvalidAbiParametersError, M as size$1, N as slice, Nt as parseStructs, Ot as ContractFunctionZeroDataError, Pt as parseAbiParameter, Q as validate$5, R as validate$4, Rt as InvalidAbiItemError, S as concat, St as extract$1, T as fromBytes$2, Tt as CallExecutionError, V as fromHex$2, Wt as ChainMismatchError, X as toString, Y as toNumber, Yt as InvalidSerializableTransactionError, Z as trimLeft$1, _t as numberToBytesLE$1, a as encodeDeployData, an as prettyPrint, at as bitMask$1, bt as assertRequest, c as multicall3Bytecode, cn as PositionOutOfBoundsError$1, ct as bytesToNumberLE$1, d as erc1271Abi, dt as ensureBytes$1, en as TransactionExecutionError, et as BaseError$1, fn as formatTransactionRequest, ft as hexToBytes$2, gt as numberToBytesBE$1, ht as memoized$1, i as isAddressEqual, it as bitLen$1, jt as decodeAbiParameters, k as padLeft, kt as RawContractError, lt as concatBytes$2, m as multicall3Abi, mt as isBytes$2, n as decodeFunctionResult, nt as aInRange$1, on as formatEther, ot as bytesToHex$2, p as erc6492SignatureValidatorAbi, pn as defineFormatter, pt as inRange$1, q as toBigInt, qt as FeePayerNonceMismatchError, rt as abool$1, s as erc6492SignatureValidatorByteCode, sn as createCursor, st as bytesToNumberBE$1, t as call, tn as TransactionNotFoundError, ut as createHmacDrbg$1, v as formatBlockParameter, vt as numberToHexUnpadded$1, w as fromBoolean, wt as getNodeError, xt as serializeStateOverride, y as IntegerOutOfRangeError, yt as validateObject$1, zt as isStructSignature } from "./call-BXLbhHje.js";
import { E as AbiEventSignatureNotFoundError, G as concat$1, H as getAddress, I as formatAbiItem$1, K as concatHex, M as DecodeLogTopicsMismatch, T as AbiEventSignatureEmptyTopicsError, U as keccak256$1, V as checksumAddress, d as formatAbiParameters, j as DecodeLogDataMismatch, r as toEventSelector, t as encodeFunctionData, u as formatAbiItem, v as AbiDecodingDataSizeTooSmallError, y as AbiDecodingZeroDataError } from "./encodeFunctionData-CpXvefvC.js";
import { T as formatGwei, a as RpcRequestError, w as UnknownNodeError } from "./createBatchScheduler-DtXytP1y.js";
...
function numToSizedHex$1(num, size) {
	return bytesToHex$2(numberToBytesBE$1(num, size));
}
var _0n$6 = BigInt(0);
var _1n$6 = BigInt(1);
var _3n$2 = BigInt(3);
	...
	*/
	...
	function normPrivateKeyToScalar(key) {
		...
		if (lengths && typeof key !== "bigint") {
			if (isBytes$2(key)) key = bytesToHex$2(key);
...
*/
function from$1(abiItem, options = {}) {
...
function wrap(value) {
	...
	return concat(encode(from$2("address, bytes, bytes"), [
		to,
		data,
		signature
	]), magicBytes$1);
...
var suffixParameters = from$2("(uint256 chainId, address delegation, uint256 nonce, uint8 yParity, uint256 r, uint256 s), address to, bytes data");
/**
* Asserts that the wrapped signature is valid.
*
* @example
...
//#endregion
export { isEqual as $, formatTransactionReceipt as $t, fromAbi as A, TransactionRejectedRpcError as At, fromRpc$1 as B, AccountTypeNotSupportedError as Bt, recoverAuthorizationAddress as C, MethodNotFoundRpcError as Ct, toRpcList as D, ResourceNotFoundRpcError as Dt, fromRpcList as E, ProviderDisconnectedError as Et, format as F, UnsupportedNonOptionalCapabilityError as Ft, yParityToV as G, InvalidVersionedHashSizeError as Gt, toHex as H, getTransactionType as Ht, assert$2 as I, UnsupportedProviderMethodError as It, Field$1 as J, sha256$3 as Jt, secp256k1$1 as K, InvalidVersionedHashVersionError as Kt, extract as L, UserRejectedRequestError as Lt, getSignatureHash as M, UnknownBundleIdError as Mt, decode as N, UnknownRpcError as Nt, NotFoundError as O, ResourceUnavailableRpcError as Ot, encode as P, UnsupportedChainIdError as Pt, fromPublicKey as Q, defineTransactionReceipt as Qt, from$3 as R, WalletConnectSessionSettlementError as Rt, getAction as S, LimitExceededRpcError as St, getCode as T, ParseRpcError as Tt, toRpc$1 as U, toBlobSidecars as Ut, fromTuple as V, assertCurrentChain as Vt, toTuple as W, EmptyBlobError as Wt, checksum as X, blobsToCommitments as Xt, assert$3 as Y, blobsToProofs as Yt, from$4 as Z, toRlp as Zt, decodeEventLog as _, InternalRpcError as _t, prepareTransactionRequest as a, formatTransaction as an, create as at, getContractError as b, InvalidRequestRpcError as bt, estimateGas as c, validate$3 as ct, getGasPrice as d, sha512 as dt, receiptStatuses as en, validate$2 as et, getBlock as f, AtomicReadyWalletRejectedUpgradeError as ft, parseEventLogs as g, DuplicateIdError as gt, getTransactionError as h, ChainDisconnectedError as ht, defaultParameters as i, defineTransaction as in, toHex$1 as it, getSelector as j, UnauthorizedProviderError as jt, from$1 as k, SwitchChainError as kt, estimateFeesPerGas as l, sha256$2 as lt, getChainId as m, BundleTooLargeError as mt, sendTransaction as n, defineBlock as nn, fromHex$1 as nt, fillTransaction as o, keccak256 as ot, BlockNotFoundError as p, AtomicityNotSupportedError as pt, createCurve$1 as q, commitmentsToVersionedHashes as qt, sendRawTransaction as r, formatBlock as rn, toBytes as rt, getTransactionCount as s, sha256 as st, writeContract as t, formatLog as tn, from$5 as tt, estimateMaxPriorityFeePerGas as u, sha384 as ut, verifyHash as v, InvalidInputRpcError as vt, getTransaction as w, MethodNotSupportedRpcError as wt, secp256k1 as x, JsonRpcVersionUnsupportedError as xt, readContract as y, InvalidParamsRpcError as yt, fromHex as z, AccountNotFoundError as zt };
